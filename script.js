document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        en: {
            ...
            hero_desc: "Stop bleeding ad spend on guesswork. We engineer scalable growth using data-driven <strong>Google Ads</strong>, high-converting <strong>Meta Ads</strong>, and flawless <strong>GTM & Analytics Setup</strong> so you track every dollar.",
            hero_cta_primary: 'Request Your Free Audit <i class="fa-solid fa-arrow-right"></i>',
            hero_cta_secondary: "See Pricing Options",
            stat_roas: "Avg. ROAS",
            ...
            service_gtm_desc: "You are losing 30% of your conversion signals. We implement server-side tracking, GTM, and GA4 to ensure 100% data integrity and algorithm feeding.",
            ...
            contact_desc: "Stop guessing and start scaling. Request your <strong>100% free, no-obligation ad account audit</strong> today. We only onboard 3 new clients per month to ensure elite quality.",
            ...
            price_essential_benefit: "Strictly for early validation. Perfect for startups and small businesses looking to establish a solid footprint on one major ad platform without overcommitting.",
            ...
            price_performance_benefit: "Over 80% of our clients choose this. The ultimate choice for growing brands. By combining Google and Meta, we create a powerful cross-platform synergy that drives users through a complete conversion funnel.",
            ...
            trust_bar_text: "Trusted by 50+ aggressive-growth brands to scale their revenue",
            testimonials_subtitle: "Don't take our word for it. Look at the numbers from our partners.",

            ads_badge: "Paid Acquisition",
            ads_title: 'High-ROAS <span class="gradient-text">Google & Meta Ads</span> Management',
            ads_desc: "Every day with poor targeting is lost revenue. We build elite, data-driven PPC campaigns powered by intent signals, creative science, and conversion-optimized funnels.",
